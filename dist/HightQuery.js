...
var HightQuery = (function () {
    ...
    HightQuery.mappingSelect = function (tableName, state, query) {
        ...
        this._cql = "SELECT " + ((Array.isArray(query.select)) ? query.select.map(function (x) { return x; }).join(', ') :
    ...
    HightQuery.create = function (tableName, state, query) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log(query);
                return [2];
