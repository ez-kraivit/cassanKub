...
var LowQuery = (function (_super) {
    ...
    LowQuery.CutText = function (text, alia) {
        var countSubStr = 0;
        var TextData = text;
        var dataSubStr2;
        while (true) {
            var dataSubStr = "";
            if (TextData.indexOf(alia) > -1) {
                countSubStr++;
                dataSubStr = TextData.substr(TextData.indexOf(alia) + alia.length, TextData.length);
                dataSubStr2 = TextData.substr(0, TextData.indexOf(alia));
                TextData = dataSubStr2 + dataSubStr;
            }
            else {
                break;
            }
    ...
    LowQuery.StringSub = function (data) {
        var CurrentData = data;
        LowQuery.ReservedWord.map(function (item) {
            CurrentData = LowQuery.CutText(CurrentData, item);
        });
        return CurrentData;
    };
    ...
    LowQuery.BatchData = function (queries) {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, cassankub_1["default"].db.batch(queries, { prepare: true }).then(function () {
                                console.info('Batch successfully.');
                            })["catch"](function (err) {
                                console.info(err.info + " query " + err.query);
                            })];
                    case 1:
