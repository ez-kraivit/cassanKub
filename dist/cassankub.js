...
var cassankub = (function (_super) {
    __extends(cassankub, _super);
    function cassankub() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    cassankub.init = function (ClientOption, showlog) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, cassankub.db.connect()];
                    case 1:
                        (typeof (_a.sent()) == 'undefined') ? cassankub._log : cassankub._log = error_1._error.Connect;
                        return [2, cassankub.db];
                }
            });
        });
    };
